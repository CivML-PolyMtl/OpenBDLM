...
if  ~isempty(misc)
    ...
    ProjectInfoFile = fullfile(pwd, misc.internalVars.ProjectPath , ...
        misc.internalVars.ProjectInfoFilename);
    
    [isFileExist]= testFileExistence(ProjectInfoFile, 'file');
    
    if ~isFileExist
    ProjectInfo = {};
    % create file
    save(ProjectInfoFile, 'ProjectInfo');
    end
