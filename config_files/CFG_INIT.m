...
%% A - Project name
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
misc.ProjectName='INIT';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% B - Data
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
dat=load('DATA_INIT.mat'); 
...
model.initX{ 1 }=[	10    	-0.1  	10    	10    	2.01  	2.02  	1.29  	0.153 	-0.775	-0.956	-0.297	0.793 	1.68  	1.92  	1.55  	0.991 	0.747 	1.01  	1.52  	1.74  	1.28  	0.171 	-1.09 	-1.87 	-1.77 	-0.958	0.0325	0.598 	0.486 	-0.0775	-0.578	-0.61 	-0.181	0.294 	0.288 	-0.434	-1.62 	-2.66 	-2.98 	-2.42 	-1.33 	-0.334	0.0785	-0.138	-0.592	-0.769	-0.421	0.246 	0.719 	0.552 	-0.289	-1.36 	-2.02 	-1.84 	0     ]';

% Initial hidden states variance for model 1: 
model.initV{ 1 }=diag([ 	0.01  	0.01  	0.04  	0.04  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01  	0.01   ]);
