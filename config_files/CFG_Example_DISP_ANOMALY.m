...
%          Autogenerated by OpenBDLM on 31-Jan-2019 13:45:54              %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% A - Project name
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
misc.ProjectName='Example_DISP_ANOMALY';
...
model.param_properties={
     ...
     '\sigma_w',   'TcA',          '1',   '1',   [0  Inf    ],    'N/A',       NaN,     NaN,            1.5018e-08,     1      %#1   
     'p',          'PD1',          '1',   '1',   [NaN  NaN  ],    'N/A',       NaN,     NaN,            365.2422,       2      %#2   
     '\sigma_w',   'PD1',          '1',   '1',   [NaN  NaN  ],    'N/A',       NaN,     NaN,            0,              3      %#3   
     '\phi',       'AR',           '1',   '1',   [0  1      ],    'N/A',       NaN,     NaN,            0.75,           4      %#4   
     '\sigma_w',   'AR',           '1',   '1',   [0  Inf    ],    'N/A',       NaN,     NaN,            0.15018,        5      %#5   
     '\sigma_v',   '',             '1',   '1',   [0  Inf    ],    'N/A',       NaN,     NaN,            0.075092,       6      %#6   
     '\sigma_w',   'LA',           '2',   '1',   [0  Inf    ],    'N/A',       NaN,     NaN,            1.5018e-08,     7      %#7   
     '\sigma_v',   '',             '2',   '1',   [0  Inf    ],    'N/A',       NaN,     NaN,            0.075092,       8      %#8   
     '\sigma_w',   'TcA',          '12',  '1',   [0  Inf    ],    'N/A',       NaN,     NaN,            1.5018e-05,     9      %#9   
     '\sigma_w',   'LA',           '21',  '1',   [0  Inf    ],    'N/A',       NaN,     NaN,            1.5018e-05,     10     %#10  
     'Z(11)',      '',             '11',  '',    [0  1      ],    'N/A',       NaN,     NaN,            0.99986,        11     %#11  
     'Z(22)',      '',             '22',  '',    [0  1      ],    'N/A',       NaN,     NaN,            0.99986,        12     %#12  
};
