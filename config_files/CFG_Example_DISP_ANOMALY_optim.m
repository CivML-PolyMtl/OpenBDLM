...
%          Autogenerated by OpenBDLM on 20-Mar-2019 09:50:29              %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
model.param_properties={
     ...
     '\sigma_w',   'TcA',          '1',   '1',   [0  Inf    ],    'N/A',       NaN,     NaN,            5.1161e-08,     1      %#1   
     'p',          'PD1',          '1',   '1',   [NaN  NaN  ],    'N/A',       NaN,     NaN,            365.2422,       2      %#2   
     '\sigma_w',   'PD1',          '1',   '1',   [NaN  NaN  ],    'N/A',       NaN,     NaN,            0,              3      %#3   
     '\phi',       'AR',           '1',   '1',   [0  1      ],    'N/A',       NaN,     NaN,            0.7233,         4      %#4   
     '\sigma_w',   'AR',           '1',   '1',   [0  Inf    ],    'N/A',       NaN,     NaN,            0.21521,        5      %#5   
     '\sigma_v',   '',             '1',   '1',   [0  Inf    ],    'N/A',       NaN,     NaN,            0.10183,        6      %#6   
     '\sigma_w',   'LA',           '2',   '1',   [0  Inf    ],    'N/A',       NaN,     NaN,            0.00066482,     7      %#7   
     '\sigma_v',   '',             '2',   '1',   [0  Inf    ],    'N/A',       NaN,     NaN,            0.076842,       8      %#8   
     '\sigma_w',   'TcA',          '21',  '1',   [0  Inf    ],    'N/A',       NaN,     NaN,            8.8257e-06,     9      %#9   
     '\sigma_w',   'LA',           '12',  '1',   [0  Inf    ],    'N/A',       NaN,     NaN,            9.6325e-06,     10     %#10  
     'Z(11)',      '',             '11',  '',    [0  1      ],    'N/A',       NaN,     NaN,            0.99995,        11     %#11  
     'Z(22)',      '',             '22',  '',    [0  1      ],    'N/A',       NaN,     NaN,            0.99963,        12     %#12  
};
...
model.initX{ 1 }=[	-9.37 	-0.0132	-7.27E-09	1.04  	-0.00772	-0.599]';

% Initial hidden states variance for model 1: 
model.initV{ 1 }=diag([ 	0.124 	0.000928	2.42  	0.000993	0.00088	0.319  ]);

% Initial probability for model 1
model.initS{1}=[0.998 ];

% Initial hidden states mean for model 2:
model.initX{ 2 }=[	-9.49 	0.105 	-0.0631	1.04  	-0.00772	-0.516]';

% Initial hidden states variance for model 2: 
model.initV{ 2 }=diag([ 	0.614 	0.49  	0.979 	0.000993	0.00088	0.69   ]);

% Initial probability for model 2
model.initS{2}=[0.0021];
