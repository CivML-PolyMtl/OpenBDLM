...
\todo{Double check on parameter estimation}This example uses a synthetic time series that mimics displacement data measured on a bridge (Figure~\ref{fig:DataSummary1}). 
