...
The figures can be exported in PDF, PNG, and \LaTeX{} to create publication-quality figures.

\subsection{RES\_*.mat result file}
...
\subsection{PROJ\_*.mat project file}
...
\subsection{DATA\_*.mat data file}
...
It is possible to export the figures in PDF, PNG\footnote{Yair Altman, 2011, export\_fig, \url{https://www.mathworks.com/matlabcentral/fileexchange/23629-export\_fig}} and \LaTeX{}\footnote{Nico Schlömer,2013, matlab2tikz, \url{https://www.mathworks.com/matlabcentral/fileexchange/22022-matlab2tikz-matlab2tikz}},\footnote{All the time-series data figures shown in this document have been created from \LaTeX{} files output from OpenBDLM. Minor post-processing have been done on the \LaTeX{} file. Compilation using LuaLatex.}.
